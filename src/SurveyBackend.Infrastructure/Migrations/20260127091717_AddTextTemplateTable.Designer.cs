...
namespace SurveyBackend.Infrastructure.Migrations
{
    ...
    [Migration("20260127091717_AddTextTemplateTable")]
    partial class AddTextTemplateTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SurveyBackend.Domain.Surveys.Question", b =>
                {
                    ...
                    b.Property<string>("MatrixExplanationLabel")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("MatrixScale1Label")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("MatrixScale2Label")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("MatrixScale3Label")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("MatrixScale4Label")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("MatrixScale5Label")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<bool>("MatrixShowExplanation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("SurveyBackend.Domain.TextTemplates.TextTemplate", b =>
                {
                    ...
                    b.ToTable("TextTemplate", (string)null);
                });
